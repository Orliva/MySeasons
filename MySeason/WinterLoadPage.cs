...
namespace MySeason
{
    ...
    {
        /// <summary>
        /// Загрузочная форма "Зима"
        /// </summary>
        sealed class WinterLoadPage : LoadingPage
        {
            #region Variable
            private readonly PictureBox puddle;
            private readonly PictureBox seadog;
            ...
            #region Ctor
            public WinterLoadPage() : base("Winter")
            {
                SuspendLayout();
                ...
                puddle = new PictureBox
                {
                    ...
                    Image = Properties.Resources.PubdleWinter,
                    BackColor = Color.Transparent
                };
            ...
            /// <summary>
            /// Запускает таймер, который отвечает за анимацию cнега
            /// </summary>
